...
@NgModule({
  ...
  declarations: [SocialImpactPageComponent, SocialImpactHeroSectionComponent,SocialImpactOpenKnowledgeComponent ],
  exports: [SocialImpactPageComponent, SocialImpactOpenKnowledgeComponent],
})
